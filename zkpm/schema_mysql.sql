...
CREATE TABLE IF NOT EXISTS `users` (`id` int NOT NULL AUTO_INCREMENT, `username` varchar(32) NOT NULL, `password` varchar(64) NOT NULL, `email` text NOT NULL, PRIMARY KEY (`id`))
...
CREATE TABLE IF NOT EXISTS `licenses` (`id` int NOT NULL AUTO_INCREMENT, `user` varchar(64) NOT NULL, `key` varchar(64) NOT NULL, `needs_hwid` tinyint(1) NOT NULL DEFAULT '0', `hwid` varchar(64) NOT NULL, `disabled` tinyint(1) NOT NULL DEFAULT '0', `expires` int(10) NOT NULL DEFAULT '0', `last_use` int(10) NOT NULL DEFAULT '0', `aban` tinyint(1) NOT NULL DEFAULT '0', PRIMARY KEY (`id`))
